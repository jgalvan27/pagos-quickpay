...
El campo **identifier** que va en body, es un campo opcional, sin embargo se recomienda enviar el gateway_order en este campo, el cual sera encriptado y devuelto dentro del token, para propositos de seguridad en las transacciones.
